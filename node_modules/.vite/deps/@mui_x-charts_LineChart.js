...
} from "./chunk-UTKTPOIZ.js";
import "./chunk-TFC7L6RE.js";
  ...
  return (0, import_jsx_runtime2.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const linePath = line_default().x((d) => xScale(d.x)).y((d) => yScale(d.y[1]));
        if (true) {
  ...
  return (0, import_jsx_runtime4.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const areaPath = area_default().x((d) => xScale(d.x)).y0((d) => yScale(d.y[0])).y1((d) => yScale(d.y[1]));
        const curve = getCurveFactory(series[seriesId].curve);
        const d3Data = xData == null ? void 0 : xData.map((x, index) => ({
          x,
          y: stackedData[index]
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        return xData == null ? void 0 : xData.map((x, index) => {
          ...
          return showMark === true || showMark({
            ...
            position,
            value
          }) ? (0, import_jsx_runtime6.jsx)(Mark, _extends({
            id: seriesId,
            dataIndex: index,
            shape: "circle",
            color: series[seriesId].color,
...
true ? LineChart.propTypes = {
  ...
  bottomAxis: import_prop_types10.default.oneOfType([import_prop_types10.default.shape({
    axisId: import_prop_types10.default.string.isRequired,
